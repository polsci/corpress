"""Core CorPress functions. You can call any of these functions directly, but use the [corpress function](https://geoffford.nz/corpress/core#corpress) if you want to gather data and output a corpus in one step."""
...
def create_corpus(corpus_format: str = 'txt', # format of the corpus files, txt or csv
    ...
    if corpus_format == 'txt':
        columns = ['date', 'datetime', 'type', 'id', 'link', 'title', 'filename']
        csv_file_type = 'metadata'
    elif corpus_format == 'csv':
        columns = ['date', 'datetime', 'type', 'id', 'link', 'title', 'text']
    ...
    try:
        ...
        if csv_save_file:
            ...
            fw = open(csv_save_file, 'w', encoding=encoding)
        ...
        for file in file_list:
            with open(file, 'r', encoding=encoding) as f:
                ...
                for article in data:
                    ...
                    if corpus_format == 'txt':
                        with open(corpus_save_path + filename, 'w', encoding=encoding) as txtfile:
        ...
        if csv_save_file:
            fw.close()
            logging.info(f'CSV file for {csv_file_type} created: {csv_save_file}')
...
def corpress(url: str, # the URL of the WordPress website 
    ...
    # create the corpus
    create_corpus_result = create_corpus(corpus_format, json_save_path, corpus_save_path, csv_save_file, include_title_in_text, encoding)
